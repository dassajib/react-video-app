...
const Videos = () => {
  ...
  const [videSrc, setVideoSrc] = useState(videosArr[0]);
    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        <video
          ...
          style={{ width: '100%' }}
        ></video>
        <VStack alignItems={'flex-start'} w={'full'} overflowY={'auto'} overflowX={"auto"} p={4}>
          <Heading>
            Video headline
          </Heading>
          <Text>
            Ekattor
            is the First TWO-WAY News and Current Affairs Television in
            Bangladesh with cutting-edge technology and content excellence. 
          </Text>
        </VStack>
      </VStack>
      <VStack
